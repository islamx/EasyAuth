...
import { signinSchema, type SigninInput, type AuthResponse, type ErrorResponse } from '@easyauth/shared';
    ...
    <div className="min-h-screen bg-zinc-950 flex items-center justify-center p-4">
      <Card className="w-full max-w-md space-y-6">
        <div>
          ...
          <p className="text-sm text-zinc-400 mt-1">Welcome back to EasyAuth</p>
        </div>
